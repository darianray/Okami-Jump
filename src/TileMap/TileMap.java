...
public class TileMap {
	...
	public void loadMap(String s) {
		...
		try {
			...
			//find width and height of pixels
	...
	public void setPosition(double x, double y) {
		////instead of this.x = x and this.y = y
		///this makes the camera GRADUALLY follow the player
		...
		///(don't draw on the entire tile map)
		///which column and row to start drawing
		colOffset = (int)-this.x / tileSize;
		rowOffset = (int)this.ymax / tileSize;
		}
	
	private void fixBounds() {
		///make sure the bounds aren't being passed
		if(x < xmin)
			x = xmin;
		if(y< ymin)
			y = ymin;
	...
	///fix outofbounds when character falls
